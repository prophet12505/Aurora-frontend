                                            ...
                                            <img src="assets/img/icon/en.png" alt="">
                                                ...
                                                <ul className="dropdown-list">
                                                    <li><a href="#"><img src="assets/img/icon/en.png"
                                                                         alt=""> english</a></li>
                                                    <li><a href="#"><img src="assets/img/icon/fr.png" alt=""> french</a>
                                                    </li>
                                                </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <div className="search-box-inner-wrap">
                                        <form className="search-box-inner">
                                            ...
                                            <div className="search-btn">
                                                <button><i className="ion-ios-search"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3">
                                <div className="category-toggle-wrap">
                                    <div className="category-toggle">
                                        ...
                                        all categories
                                        <span><i className="ion-android-arrow-dropdown"></i></span>
                                    </div>
                                    <nav className="category-menu">
                                        <ul className="categories-list">
                                            ...
                                            <li className="menu-item-has-children"><a href="shop.html">dairy & eggs</a>
                                                <!-- Mega Category Menu Start -->
